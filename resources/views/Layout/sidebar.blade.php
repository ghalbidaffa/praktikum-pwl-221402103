 ...
 <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item {{ request()->is('admin/series') ? 'active' : ''}}">
        <a class="nav-link" href="/admin/series">
            <i class="fas fa-fw fa-folder"></i>
            <span>My Favorit Series</span></a>
    </li>
   
    <li class="nav-item {{ request()->is('admin/album') ? 'active' : ''}}">
        <a class="nav-link" href="/admin/album">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>My Playlist</span></a>
    </li>

    <li class="nav-item {{ request()->is('admin/char') ? 'active' : ''}}">
        <a class="nav-link" href="/admin/char">
            <i class="fas fa-fw fa-table"></i>
            <span>My Favorite Character</span></a>
    </li>
    <!-- Divider -->
